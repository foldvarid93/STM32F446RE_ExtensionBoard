...
void LCD_X_Config(void) {
  ...
  //
  pDevice = GUI_DEVICE_CreateAndLink(GUIDRV_TEMPLATE, GUICC_M565, 0, 0);//16bit color flexcolor driver GUICC_565=RGB
  //pDevice = GUI_DEVICE_CreateAndLink(GUIDRV_FLEXCOLOR, GUICC_565 , 0, 0);//GUICC_565=BGR
  //
